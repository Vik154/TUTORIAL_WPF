...
_Свойства зависимостей имеют встроенный механизм уведомления об изменениях. Зарегистрировав обратный вызов в метаданных свойств, вы получите уведомление, когда значение свойства было изменено. Это также используется привязкой данных._
* 
