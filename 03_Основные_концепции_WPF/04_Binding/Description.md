...
<img align="left" width="200" height="150" src="img/Bind5.png" alt="Пример работы данного кода"/>
...
Свойства Source и Path класса Binding - задают источник привязки, а с помощью метода SetBinding устанавливается привязка у объекта-приемника.
