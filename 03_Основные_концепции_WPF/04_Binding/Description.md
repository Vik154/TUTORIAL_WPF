...
___Обновление привязки. UpdateSourceTrigger___ <br>
> *MSDN: https://learn.microsoft.com/ru-ru/dotnet/api/system.windows.data.binding.updatesourcetrigger?view=windowsdesktop-7.0#system-windows-data-binding-updatesourcetrigger*
...
* _PropertyChanged:_ источник привязки обновляется сразу после обновления свойства в приемнике.
