...
<img align="left" width="180" height="160" src="img/Res4.png" alt="Пример работы данного кода"/>

<div style="margin-left:20;">
    <ul> Класс ResourceDictionary содержит ряд полезных методов и свойств:
        &nbsp <li> Add(string key, object resource) добавляет объект по ключу в словарь </li>
        &nbsp <li> Remove(string key) удаляет из словаря ресурс с ключом key </li>
        &nbsp <li> Uri устанавливает источник словаря </li>
        &nbsp <li> Keys возвращает все имеющиеся в словаре ключи </li>
        &nbsp <li> Values возвращает все имеющиеся в словаре объекты </li>
    </ul>
</div>
