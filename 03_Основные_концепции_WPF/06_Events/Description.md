...
События времени жизни всех элементов управления  и указаны в таблице


<div>
    <table>
        <caption><b>События времени жизни элементов (наследуются от FrameworkElement)</b></caption>
            <tbody>
                <tr>
                    <th>Событие</th>
                    <th>Описание</th>
