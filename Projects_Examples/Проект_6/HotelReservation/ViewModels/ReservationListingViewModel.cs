...
public class ReservationListingViewModel : BaseViewModel {
    ...
    public ReservationListingViewModel(NavigationStore navigationStore, Func<MakeReservationViewModel> moveModels) {
        _reservations = new() {
        ...
        MakeReservationCommand = new NavigateCommand(navigationStore, moveModels);
    }
}
